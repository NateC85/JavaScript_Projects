...
function placeXOrO(squareNumber) {
    ...
    // The .some() method is user to check each element of selectedSquare array
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/x-2.png")';
    ...
    // This function resuts in a random square being selected.
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        // returned and our else if codition executes the drawWinLine function.
        if (a === true && b === true && c === true) { return true }
    }

}

// This function makes our body element temperarily unclickable.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        // This method draws out everything we layed out above.
        c.stroke();
...
function resetGame() {
    // This for loop iterates through eack HTML square element.
    for (let i = 0; i < 9; i++) {
